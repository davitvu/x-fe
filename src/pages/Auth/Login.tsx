            ...
            <div className="flex flex-col flex-grow h-full md:flex-row md:items-center md:justify-center">
                ...
                <div className="md:w-[44%] sm:w-1/2 md:p-5 lg:w-[42%] text-black dark:text-white">
                    ...
                    <div className="w-full md:w-[300px] max-h-5 flex items-center justify-center my-2">
                        <div className="flex-grow bg-[#f0f3f4] dark:bg-[#303336] h-[1px]"></div>
                        <p className="inline-block px-2 text-sm bg-white dark:bg-black">OR</p>
                        <div className="flex-grow bg-[#f0f3f4] dark:bg-[#303336] h-px"></div>
                    </div>
                    ...
                    <div className="w-full md:w-[300px] text-[10px] mb-10 dark:text-[#71767B]">
                        <p>By signing up, you agree to the <span className="text-[#1D9BF0]">Terms of Service</span> and <span className="text-[#1D9BF0]">Privacy Policy</span>, including <span className="text-[#1D9BF0]">Cookie Use.</span></p>
                    </div>
                    <p className="mb-4 font-semibold">Already have an account?</p>
                    <a href="#" className="mb-9 w-full md:w-[300px] h-[38px] flex items-center justify-center border-[1px] transition-all duration-300 ease-in-out border-[#d1d9de] dark:border-[#566470] bg-white dark:bg-black hover:bg-[#ecf5fd] dark:hover:bg-[#1d9bf01a] rounded-[20px]">
